...
SECRET_KEY = 'y$*#1o-j(__y#t=mrk-o++5_95@ps(rh=%(z8($&=do4fr4s37'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'alumni_portal', # name of the database
        'USER': 'admin', # create a user in postgres of this name
